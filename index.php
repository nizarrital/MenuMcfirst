...
<html class="no-js" lang="en">
  <head>
    ...
    <title>McFirst Sports Shop</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">McFirst Sports Shop</a></h1>
        </li>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;">&copy; McFirst Sports Shop. All Rights Reserved.</p>
        </footer>
